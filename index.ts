 ...
 * ## EML Core
 *
 * Be careful: **this NodeJS library requires [Electron](https://www.npmjs.com/package/electron)!** 
 * You need Electron for the Microsoft login.
 *
 * Create your Electron Minecraft Launcher easily.
 * To get all the capacities of this Node.js library, it is highly recommended to set up your 
